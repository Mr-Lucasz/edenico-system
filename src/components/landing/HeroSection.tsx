    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 pt-24 lg:grid-cols-2 lg:gap-16 lg:pt-28">
        ...
        <div className="relative z-10 text-center lg:col-start-2 lg:text-left">
          ...
          {/* Botões abaixo do card — mesma largura, como no print */}
          <div
          ...
          >
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#2F80ED] px-4 py-3 text-sm font-medium text-white transition-opacity hover:opacity-90"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-edenicos-purple px-4 py-3 text-sm font-medium text-white transition-opacity hover:opacity-90"
            >
              <FiBook className="h-5 w-5 shrink-0" aria-hidden />
              Professores
            </button>
            <button
              type="button"
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-edenicos-cta-magenta px-4 py-3 text-sm font-medium text-white transition-opacity hover:opacity-90"
            >
              <FiUsers className="h-5 w-5 shrink-0" aria-hidden />
              Pais
            </button>
          </div>
        </div>
